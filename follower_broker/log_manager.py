"""
Log Manager for Follower Broker
Handles message storage and retrieval (identical to leader's log manager)
"""
import threading
...
class LogManager:
    ...
    def append(self, data: Any, message_id: str, timestamp: float, offset: int = None) -> Optional[int]:
        """
        Append a message to the log at a specific offset
        ...
        with self.lock:
            ...
            # Use provided offset or next sequential offset
            if offset is None:
